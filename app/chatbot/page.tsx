  ...
  if (!selectedMentor) {
    return (
      <div className="min-h-screen bg-gray-900 text-white p-8">
        <Link href="/" className="fixed top-6 left-6 z-50 px-4 py-2 bg-gray-700 rounded hover:bg-gray-600">Volver</Link>
        <h1 className="text-3xl font-bold mb-12 text-center mt-16">Elige a tu Asesor Financiero IA</h1>
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      <header className="p-4 bg-gray-800 flex items-center gap-4">
        <button onClick={() => setSelectedMentor(null)} className="fixed top-6 left-6 z-50 bg-gray-800 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded border border-gray-600">
          Volver
        </button>
